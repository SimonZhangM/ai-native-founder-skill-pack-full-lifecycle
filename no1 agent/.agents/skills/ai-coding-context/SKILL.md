...
description: "生成 AI 编程上下文：AGENTS.md/CODEX.md、架构原则、session log、验收命令和安全边界；trigger: Codex context, Claude Code context, AI coding, 架构上下文。不自动改代码。"
---
...
3. Generate architecture context using `../../shared/templates/architecture-context.md`.
4. Generate build session log using `../../shared/templates/build-session-log.md`.
