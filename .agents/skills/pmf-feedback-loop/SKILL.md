---
name: pmf-feedback-loop
description: "建立 PMF 反馈循环：activation, retention, D7/D30, revenue, referral, Sean Ellis, false positives, pivot diagnostic；trigger: PMF, 留存, early traction, 反馈循环。"
---
...
5. If data is available as JSON, run `python ../../shared/scripts/pmf_signal_score.py <metrics.json>`.
