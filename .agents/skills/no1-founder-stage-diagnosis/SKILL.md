---
name: no1-founder-stage-diagnosis
description: "Use when a founder needs to identify the evidence-backed startup stage, evaluate Idea/MVP/Launch/Scale readiness, or decide whether to build, launch, scale, or gather more evidence."
---
...
- The user asks: "鎴戠幇鍦ㄥ湪鍝釜闃舵锛?, "should we build?", "should we launch?", "should we scale?"
...
3. Run the relevant gate using `../../shared/no1/references/lifecycle-stage-gates.md`.
4. If a JSON evidence file exists, run `python ../../shared/no1/scripts/stage_gate_check.py <file>`.
